...
import dev.takesome.helix.ui.markup.UiMarkupParseOptions;
import dev.takesome.helix.ui.markup.internal.parse.diagnostics.UiHtmlDiagnosticFactory;
import dev.takesome.helix.ui.markup.internal.parse.scanner.UiHtmlScanner;
import dev.takesome.helix.ui.markup.internal.parse.scanner.UiHtmlToken;
import dev.takesome.helix.ui.markup.internal.parse.scanner.UiHtmlTokenType;
import dev.takesome.helix.ui.markup.internal.parse.syntax.UiHtmlSyntaxProfile;
import dev.takesome.helix.ui.markup.internal.parse.tree.UiHtmlTreeBuilder;

import java.util.Objects;

/**
 * Tolerant HTML-like parser facade for HELIX UI Markup.
 *
