...
import dev.takesome.helix.ui.html.UiHtmlDiagnosticSink;
...
import dev.takesome.helix.ui.markup.internal.parse.diagnostics.UiHtmlSourceMap;
import dev.takesome.helix.ui.markup.internal.parse.scanner.UiHtmlNameCanonicalizer;
...
public final class UiHtmlParseSession {
    ...
    private IllegalArgumentException strictException(UiMarkupDocument document) {
        ...
        return new IllegalArgumentException(
                "Invalid HELIX UI markup in strict mode: "
                        + first.code()
                        + " at "
                        + first.jumpTarget()
                        + " - "
