...
public enum FontAwesomeStyle {
    SOLID(
            ...
            "Font Awesome Solid",
            "dev/takesome/helix/ui/icons/fontawesome/fa-solid-900.ttf"
    ),
    REGULAR(
            FontAwesomeIconFamily.of("regular", "fontawesome-regular", FontAwesomeRegularIcon::values),
            "Font Awesome Regular",
            "dev/takesome/helix/ui/icons/fontawesome/fa-regular-400.ttf"
    ),
    BRANDS(
            FontAwesomeIconFamily.of("brands", "fontawesome-brands", FontAwesomeBrandIcon::values),
            "Font Awesome Brands",
            "dev/takesome/helix/ui/icons/fontawesome/fa-brands-400.ttf"
    );
    ...
    private static String normalize(String value) {
        return lowerTrimToEmpty(value, Locale.ROOT).replace('_', '-');
    }
}
