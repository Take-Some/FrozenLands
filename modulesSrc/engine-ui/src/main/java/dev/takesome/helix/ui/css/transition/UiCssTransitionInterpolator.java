...
public final class UiCssTransitionInterpolator {
    ...
    private static TransformValue transform(String raw) {
        ...
        if (value.isBlank() || "none".equals(value)) {
            return new TransformValue(new NumericValue(0.0, ""), new NumericValue(0.0, ""), 1.0);
        }
        ...
        return found ? new TransformValue(x, y, scale) : null;
    }
    ...
    private record TransformValue(NumericValue x, NumericValue y, double scale) {
